...
class CsvCreator(private val root: String) {

  import CsvCreator.fileNameToHeadingsMap
  ...
  private def processFile(
      typeToWriterMap: Map[String, PrintWriter]
  )(f: File): Unit = {
...
object CsvCreator extends App {
  ...
  new CsvCreator(s"${sys.env("HOME")}/Development/ee/cip/tmp").process()
}
