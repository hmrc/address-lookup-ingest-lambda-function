...
object Dependencies {
  ...
  val compile: Seq[ModuleID] = Seq(
    ...
    "com.amazonaws.secretsmanager"       % "aws-secretsmanager-caching-java"  % "2.1.0" exclude("software.amazon.awssdk", "third-party-jackson-core") exclude("software.amazon.awssdk", "sdk-core"),
